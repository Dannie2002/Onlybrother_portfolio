  ...
  return (
    ...
    <div className="absolute inset-0 z-10 overflow-hidden pointer-events-none">
     ...
     <div className="absolute inset-0 pointer-events-none -z-5">
       ...
       <img src={ink} alt="arrow" className="absolute h-26 w-26 opacity-20 rotate-12 animate-pulse" style={{ top: '55%', left: '35%' }} />
     </div>
              ...
              />
               ...
               <div className='flex justify-center gap-4'>
                ...
                <FadeContent blur={false} duration={4000} easing="ease-out" initialOpacity={0} delay={800}>
                  <a href="#cv" className=" inline-flex items-center justify-center px-6 py-3 font-bold text-black transition-all duration-300 bg-transparent border-2 rounded border-[#b98815] hover:border-none hover:bg-[#b98815] hover:text-white gap-2">
